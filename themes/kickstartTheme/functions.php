...
function theme_files() {
  ...
  wp_enqueue_style('kickstart_eventsCard_styles', get_theme_file_uri('/css/eventsCard.css'));
  wp_enqueue_style('kickstart_podcastCard_styles', get_theme_file_uri('/css/podcastCard.css'));
